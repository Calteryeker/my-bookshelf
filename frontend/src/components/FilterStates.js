...
const FilterStates = ({status, myBooks, filterReading, filterFinished}) =>{
    return (
        <div className={ status + ` sm_c:flex flex sm_c:flex-row  sm_c:justify-center md_c:flex md_c:flex-col md_c:items-start md_c:ml-10 md_c:text-[0.8em]`} >
            <div className="flex flex-row justify-center md_c:text-brow_pod-1 md_c:mt-5 cursor-pointer" onClick={myBooks}>
            ...
            <div className="flex flex-row justify-center md_c:text-brow_pod-1 md_c:mt-5 cursor-pointer" onClick={filterReading}>
            ...
            <div className="flex flex-row justify-center md_c:text-brow_pod-1 md_c:mt-5 cursor-pointer" onClick={filterFinished}>
