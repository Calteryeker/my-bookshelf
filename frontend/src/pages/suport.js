    ...
    return (
        <div className="pt-28 flex flex-col justify-between bg-romantic-1 min-h-screen">  
            ...
            <Header title={"Suporte"}>
                <button className="rounded-xl left-2 md:left-10 fixed text-left text-base hover:bg-orange-500 hover:text-white duration-500 p-2 bg-romantic-1 text-brow_pod-1"><a href="/home">Home</a></button>
            </Header>
            <div className="my-3 bg-white rounded-2xl mx-auto w-96 pb-10 md_c:w-[858px] md_c:mx-auto">
                <div className="flex flex-col items-center">
                    <img src="/images/suporte-icon.png" className="mx-auto mt-10" width={80} height={80} />
                ...
                <div className="flex flex-col items-center mx-10 ">
                    <Formik initialValues={{}} onSubmit={handleSubmit} validationSchema={validationMessage}>
                        <Form className="mt-3 w-[100%]">
                            <h2 className="text-[1.5rem] leading-6 font-medium text-gray-900 my-[1.25rem]">Envie sua mensagem</h2>
                            <div className="my-2 ">
                                <Field className="w-[100%] rounded-2xl py-3 border-brow_pod-1 border-2 pl-2 font-inter" name="title" placeholder="Título da Mensagem"/>
                                <ErrorMessage component="p" name="title" className="text-xs text-red-700 text-center"/>
                            </div>
                            <div className="my-2">
                                <Field className="w-[100%]  rounded-2xl py-3 border-brow_pod-1 border-2 pl-2 font-inter" as="textarea" name="message" placeholder="Mensagem"/>
                                <ErrorMessage component="p" name="message" className="text-xs text-red-700 text-center"/>
                            </div>
                            <button type="submit" className="mx-[4.9em] md_c:mx-[19em] font-luck rounded-xl text-center text-base hover:bg-orange-500 hover:text-white duration-500 p-2 bg-romantic-1 text-brow_pod-1">Enviar Mensagem</button>
                        </Form>
                    </Formik>
                </div>
