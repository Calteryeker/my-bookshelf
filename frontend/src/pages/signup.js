...
export default function Signup() {
  ...
  return (
    <div className="pt-28 flex flex-col overflow-y-scroll justify-between bg-signup-bg bg-no-repeat bg-cover min-h-screen ">
      <Head>
        <title>MyBookshelf | Cadastro</title>
        <link rel="icon" href="/logo.png" />
      </Head>
      <Navbar />
      <div className="rounded-lg pt-10 mb-10 flex flex-col items-center bg-white bg-opacity-80 sm_c:mt-10 sm_c:mx-6">
      <img classname="sm_c:mx-auto justify-center" width={80} height={80} src="/images/logo_bg_brow.png"/>
      <h2 className="font-luck flex items-center justify-center sm_c:mt-10 sm_c:text-2xl sm_c:text-center sm_c:mx-2 sm_c:text-brow_pod-1 hover:text-white hover:bg-orange-500 duration-500 md:py-4 md:text-lg md:px-10 ">Faça Login ou Registre-se em Segundos</h2>
          ...
          <Form className="signup-form">
            ...
            <div className="signup-form-group py-2">
              <label className="sm_c:grid sm_c:grid-cols-1 sm_c:gap-0">Nome Completo:
                <div><Field name="name" className="font-inter sm_c:form-field sm_c:rounded-2xl sm_c:py-3 sm_c:px-24 sm_c:border-brow_pod-1 sm_c:border-2 sm_c:pl-2" placeholder="Digite seu nome" /></div>
            ...
            <div className="signup-form-group py-2">
              <label className="sm_c:grid sm_c:grid-cols-1 sm_c:gap-0">ID Login:
                <div><Field name="username" className="font-inter sm_c:form-field sm_c:rounded-2xl sm_c:py-3 sm_c:px-24 sm_c:border-brow_pod-1 sm_c:border-2 sm_c:pl-2" placeholder="Digite seu username" /></div>
            ...
            <div className="signup-form-group py-2">
              <label className="sm_c:grid sm_c:grid-cols-1 sm_c:gap-0">Email:
                <div><Field name="email" className="font-inter sm_c:form-field sm_c:rounded-2xl sm_c:py-3 sm_c:px-24 sm_c:border-brow_pod-1 sm_c:border-2 sm_c:pl-2" placeholder="user@email.com.br" /></div>
            ...
            <div className="signup-form-group py-2">
              <label className="sm_c:grid sm_c:grid-cols-1 sm_c:gap-0">Senha:
                <div><Field type="password" name="password" className="font-inter sm_c:form-field sm_c:rounded-2xl sm_c:py-3 sm_c:px-24 sm_c:border-brow_pod-1 sm_c:border-2 sm_c:pl-2" placeholder="Digite sua senha" /></div>
            ...
            <div className="signup-form-group py-2">
              <label className="sm_c:grid sm_c:grid-cols-1 sm_c:gap-0">Confirmar Senha:
                <div><Field type="password" name="confirmPassword" className="font-inter sm_c:form-field sm_c:rounded-2xl sm_c:py-3 sm_c:px-24 sm_c:border-brow_pod-1 sm_c:border-2 sm_c:pl-2 " placeholder="Confirme sua senha" /></div>
